...
public abstract class TestMengdeADT<T> {
    ...
    MengdeADT<String> testMengde1;
    MengdeADT<String> testMengde2;
    MengdeADT<String> testMengdeSnitt;
    MengdeADT<String> testMengdeUnion;
    MengdeADT<String> testMengdeTom;
    MengdeADT<String> testMengde1kopi;

    protected abstract MengdeADT<String> creatInstance();

    @BeforeEach
    public void setUp(){
        testMengde1 = creatInstance();
        testMengde2 = creatInstance();
        testMengdeSnitt  = creatInstance();
        testMengdeUnion  = creatInstance();
        testMengdeTom  = creatInstance();
        testMengde1kopi  = creatInstance();
